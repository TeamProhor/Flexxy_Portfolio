...
export const HowItWorks = ({ dict, stepsData }: Readonly<HowItWorksProps>) => {
  ...
  return (
    <section
      id="how-it-works"
      className="flex flex-col max-w-4xl mx-auto w-full px-6 md:px-0"
    >
      <ScrollReveal>
      ...
      <div className="relative flex flex-col gap-12" ref={containerRef}>
        <div className="absolute left-[20px] md:left-[23px] top-0 bottom-0 w-[2px] bg-zinc-200 dark:bg-zinc-800 z-0" />
        <div
          className="progress-line absolute left-[20px] md:left-[23px] top-0 w-[2px] bg-rose-500 origin-top z-0"
          ...
          return (
            ...
            >
              <div className="relative z-10 w-10 h-10 md:w-12 md:h-12 bg-background border border-gray-300 rounded-full flex-shrink-0 flex items-center justify-center shadow-sm overflow-hidden">
                <div
                  className={`step-icon-container-${i} flex items-center justify-center text-gray-400`}
                >
                  <div className="relative flex items-center justify-center w-full h-full">
                    ...
                    <div className={`step-spinner-${i}`}>
                      <Spinner
                        className="w-5 h-5 md:w-6 md:h-6 animate-spin-slow"
                        weight="bold"
                      />
                    </div>
                  </div>
              ...
              <div
                className={`flex flex-col gap-4 ${!item.isLast ? "pb-12" : ""} ${i > 0 ? "mt-2 md:mt-4" : ""}`}
              >
