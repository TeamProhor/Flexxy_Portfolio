...
export function Testimonials({
  ...
  const initialState: TestimonialState = {
    activeIndex: 0,
    isAnimating: false,
    displayedQuote: testimonialsData[0].quote,
    displayedRole: testimonialsData[0].role,
    hoveredIndex: null,
  };
    ...
    contextSafe(() => {
      ...
      if (prefersReducedMotion) {
        dispatch({
          type: "END_ANIMATION",
          index,
          quote: testimonialsData[index].quote,
          role: testimonialsData[index].role,
        });
                      ...
                      >
                        ...
                        <SealCheck
                          ...
                          className={cn(
                            ...
                            isActive ? "text-background" : "text-rose-500",
                          )}
                        />
                      </span>
                    </div>
