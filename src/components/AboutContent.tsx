    ...
    <section className="w-full max-w-5xl mx-auto px-6 pb-32">
      <div className="flex flex-col gap-24">
        ...
        <ScrollReveal>
          <div className="flex flex-col md:flex-row gap-12 md:gap-24 items-center">
            <div className="w-full md:w-1/2">
              ...
              <p className="text-lg text-zinc-500 leading-relaxed font-light mb-6">
            ...
            <div className="w-full md:w-1/2">
              <div className="relative w-full aspect-square md:aspect-[4/5] rounded-[24px] overflow-hidden bg-zinc-100 shadow-sm">
                <Image 
        ...
        <ScrollReveal delay={0.1}>
          <div className="bg-[#171717] rounded-[32px] p-10 md:p-16 flex flex-col md:flex-row gap-12">
